 ...
 * @author  Gary Jones
 */
class Plugin_Customizer_Template_Loader extends Gamajo_Template_Loader {
	/**
	...
	* @var string
	*/
	protected $filter_prefix = 'plugin_customizer';
	...
	* @var string
	*/
	protected $theme_template_directory = 'plugin-customizer';
	...
	* @var string
	*/
	protected $plugin_directory = PLUGIN_CUSTOMIZER_PLUGIN_DIR;
